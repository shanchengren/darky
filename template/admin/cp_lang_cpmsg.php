...
'bakup_instart'				=> '共{$GLOBALS[count]}个表需要恢复<br>准备开始恢复...',
'bakup_in'					=> '正在导入表{$GLOBALS[tb_name]}($GLOBALS[tb_sign])的第{$GLOBALS[i]}($GLOBALS[sql_sign])卷备份文件，程序将自动导入余下备份文件...',
'bakup_out'					=> '已全部备份,备份文件保存在data/sqlback目录下，本次备份目录为<br>$GLOBALS[bakfile]',
'bakup_error'				=> '备份失败!临时文件读写失败',
'bakin_error'				=> '恢复失败!临时文件读写失败',
'bakup_start'				=> '共{$GLOBALS[count]}个表需要备份<br>准备开始备份...',
