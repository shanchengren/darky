	...
	<div style="width:310px;">\
		...
		<form name="B_editor_videoForm" class="B_tableA">\
			<table width="100%" class="B_mb10">\
				<tbody><tr>\
					<td width="60">地址：</td>\
					<td><input name="url" type="text" class="B_input B_fl" size="35"><a href="#" class="B_helpA"  onclick="event&&(event.returnValue=false)"><i>支持rm wmn avi flv swf等视频格式链接地址<br />示例：http://server/filename.wmv<br>支持优酷、土豆等视频网站的视频网址</i></a></td>\
				</tr><tr>\
					<td>尺寸：</td>\
