...
function player_wmv(url,width,height,id) {
	...
	if (is_ie) {
		...
		return "<object data=\""+url+"\" type=\"application/x-mplayer2\" id=\""+id+"\" width=\""+width+"\" height=\""+height+"\" ShowStatusBar=\"true\"><embed type=\"application/x-mplayer2\" src=\""+url+"\" width=\""+width+"\" height=\""+height+"\" ShowStatusBar=\"true\"></embed></object>";
	} else if (agt.indexOf('safari')!=-1) {
		return "<object type=\"application/x-mplayer2\" id=\""+id+"\" width=\""+width+"\" height=\""+height+"\"><param name=\"src\" value=\""+url+"\" /><param name=\"ShowStatusBar\" value=\"true\" /></object>";
	} else {
		return "<object classid=\"CLSID:22D6F312-B0F6-11D0-94AB-0080C74C7E95\" id=\""+id+"\" width=\""+width+"\" height=\""+height+"\"><param name=\"src\" value=\""+url+"\" /><param name=\"ShowStatusBar\" value=\"true\" /><embed type=\"application/x-mplayer2\" src=\""+url+"\" width=\""+width+"\" height=\""+height+"\" ShowStatusBar=\"true\"></embed></object>";
	}
}