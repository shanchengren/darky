...
//	      echo "操作版块"."\t";
	...
	$set['param']['opr']  && $set['param']['opr'] =  intval($set['param']['opr']);
	$set['param']['post'] && $set['param']['post'] =  intval($set['param']['post']);
	$set['param']['oltime'] && $set['param']['oltime'] =  intval($set['param']['oltime']);
