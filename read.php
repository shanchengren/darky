...
if (!$displayMode && $isTucool && $forumset['iftucool'] && $forumset['iftucoolbrowse']) {
...
$pages = numofpage($count+$topped_count,$page,$numofpage,"read.php?tid=$tid{$urladd}$viewbbs&displayMode=1&");
